...
# Run the above line to install ComplexHeatmap.
# Afterwards, comment it out.

library(ComplexHeatmap)

normalized_counts <- counts(deseq_object, normalized=TRUE)
...
# Uncomment the above two lines if you need the 
# below libraries.

library(knitr)
library(clusterProfiler)

clusterProfiler_results <- results(deseq_object)
...
kable(significantly_enriched, format="html", caption = "Enriched")
```